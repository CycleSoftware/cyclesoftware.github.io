...
| Property            | Type       | Description                                   |
|---------------------|------------|-----------------------------------------------|
| `updates`           | `object[]` | Array with data objects, maximum of 150 items |
...
| `results[].article`                             | `object`   | `false`  | Object with resulting article details                                                                                                                                                                                                                                                        |
...
| `results[].skipped_fields`                      | `string[]` | `false`  | Array of fields which are ignored in the update                                                                                                                                                                                                                                              |
| `results[].warnings`                            | `object[]` | `false`  | Array of warnings                                                                                                                                                                                                                                                                            |
...
| `results[].error`                               | `object`   | `false`  | Object with error info                                                                                                                                                                                                                                                                       |
