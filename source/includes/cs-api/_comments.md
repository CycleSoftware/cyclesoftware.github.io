...
| `entity_type_id`     | `integer`   | <code>POST</code>          | Entity type e.g. `7`, see common API `entity_types`<br/>Currently the following entity type id's are allowed (1,3,4,5,6,7) see common API entity_types |
