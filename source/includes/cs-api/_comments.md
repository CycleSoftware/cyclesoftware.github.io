...
| `comment_type_label` | `string`    | <code>PUT&#124;POST</code> | Comment Type label see common API `comment_types`                        |
...
|---------------------|----------|----------------------------------------------------------------|
| `entity_type_id`    | `int`    | Entity type e.g. `7`, see common API `entity_types`            |
| `entity_id`         | `int`    | Entity ID e.g. sales order number when `entity_type_id` is 7   |
