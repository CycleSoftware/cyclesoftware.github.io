...
| `Order.OrderItems.OrderItem`                                            | `object[]`            | List of OrderItem objects                                                                                                                                                                                                                                                                           |
...
| `Order.OrderItems.OrderItem[].order_item_vat_code`                      | `integer`             | `0`: no VAT, `1`: Low VAT, `2` High VAT (see common enum vat_codes)                                                                                                                                                                                                                                 |
...
| `UpdateValues.UpdateValue`                                              | `object[]`            | List of UpdateValue objects                                                                                                                                                                                                                                                                         |
