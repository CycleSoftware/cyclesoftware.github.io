...
| `data[].sales_order.customer_id`                                     | `integer`              | Customer ID of the sales order. If split order is used this might be different compared to the customer_id of the sales-transaction                            |
...
| `workshop_order.object.category_name`                                | `string`               | Category name of repair object e.g. `Stadsfietsen`                                                                                                             |
| `workshop_order.object.sub_category_name`                            | `string`               | Sub-category name of repair object e.g. `Heren`                                                                                                                |
...
| `data[].sales_items[].sales_transaction_number`                      | `?integer`             | If this is an order item and invoice is created, this is the sales-transaction-number e.g. `63883` (omitted if the sales-data is based from sales-transaction) |
...
| `data[].sales_items[].sales_order_item_id`                           | `int`                  | Sales order item ID, if transaction is created from sales-order-item this will be the same ID                                                                  |
| `data[].sales_items[].unit_work_time_minutes`                        | `?int`                 | Unit work time in minutes if known                                                                                                                             |
| `data[].sales_items[].workshop_rate_id`                              | `?int`                 | Workshop rate ID if known. See common enum for `workshop_rates`                                                                                                |
