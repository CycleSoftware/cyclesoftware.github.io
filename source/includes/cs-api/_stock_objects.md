...
| `has_front_suspension`                | `boolean`  |            | Has front suspension e.g. `false`                                                            |
| `front_suspension_brand`              | `string`   |            | Brand front suspension system e.g. `SRAM` (see `/api/v4/articledata/codelist/brand.json`)    |
| `front_suspension_model`              | `string`   |            | Model front suspension e.g. `Modelname`                                                      |
| `rear_suspension_brand`               | `string`   |            | Brand rear suspension system e.g. `SRAM` (see `/api/v4/articledata/codelist/brand.json`)     |
| `rear_suspension_model`               | `string`   |            | Model rear suspension e.g. `Modelname`                                                       |  
...

{
    ...
    "object": {
        ...
        "front_suspension_brand": "",
        "front_suspension_model": "",
        "rear_suspension_brand": "",
...
| `updates[].has_front_suspension`       | `boolean`   |            | Has front suspension e.g. `false`                                                                                                       |
| `updates[].front_suspension_brand`     | `string`    |            | Brand front suspension system e.g. `SRAM` (see `/api/v4/articledata/codelist/brand.json`)                                               |
| `updates[].front_suspension_model`     | `string`    |            | Model front suspension e.g. `Modelname`                                                                                                 |
| `updates[].rear_suspension_brand`      | `string`    |            | Brand rear suspension system e.g. `SRAM` (see `/api/v4/articledata/codelist/brand.json`)                                                |
| `updates[].rear_suspension_model`      | `string`    |            | Model rear suspension e.g. `Modelname`                                                                                                  |
