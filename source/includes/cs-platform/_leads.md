...
| `sales_lead.store_id`                                | `string`   | The store identification format of \[account\]-\[store\]                    | 43831                                        |
...
| `sales_lead.costs_ex_vat_cents`                      | `integer`  | The costs that the platform charges to the dealer on acceptance of the lead | 1500                                         |
